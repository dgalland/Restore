...
public :
	...
	void SearchMVs(MVGroupOfFrames *pSrcGOF, MVGroupOfFrames *pRefGOF,
                  ...
                  int flags, int *out, short * outfilebuf, int fieldShift, DCTClass * DCT, int _pzero, int _pglobal, int badSAD, int badrange);
	...
	void RecalculateMVs(MVClip &mvClip, MVGroupOfFrames *pSrcGOF, MVGroupOfFrames *pRefGOF,
                  ...
                  int flags, int *out, short * outfilebuf, int fieldShift, int thSAD, DCTClass * DCT, int smooth);
};
