...
GroupOfPlanes::GroupOfPlanes(int nWidth, int nHeight, int _nBlkSizeX, int _nBlkSizeY, int _nLevelCount, int _nPel, int _nFlags, int _nOverlapX, int _nOverlapY, int _nBlkX, int _nBlkY, int _yRatioUV, int _divideExtra)
{
