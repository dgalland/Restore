...
extern "C" Processor Expand_expand8_isse;
extern "C" Processor Expand_expand8_3dnow;
extern "C" Processor Expand_expand8_sse2;
extern "C" Processor Expand_expand8_asse2;
...
public:
   Filter(const Parameters&parameters) : Morphologic::Filter( parameters )
   {
      ...
      if ( parameters["mode"].toString() == "square" )
      {
         ...
         processors.push_back(Filtering::Processor<Processor>(Expand_expand8_isse, Constraint(CPU_ISSE, 8, 1, 1, 1), 1));
         processors.push_back(Filtering::Processor<Processor>(Expand_expand8_3dnow, Constraint(CPU_3DNOW, 8, 1, 1, 1), 2));
         processors.push_back(Filtering::Processor<Processor>(Expand_expand8_sse2, Constraint(CPU_SSE2, 8, 1, 1, 1), 3));
         processors.push_back(Filtering::Processor<Processor>(Expand_expand8_asse2, Constraint(CPU_SSE2, 8, 1, 16, 16), 4));
      }
