...
typedef void (Processor)(Byte *pDst, int nDstPitch, const Byte *pSrc, int nSrcPitch, int nMaxDeviation, const int *pCoordinates, int nCoordinates, int nWidth, int nHeight);
