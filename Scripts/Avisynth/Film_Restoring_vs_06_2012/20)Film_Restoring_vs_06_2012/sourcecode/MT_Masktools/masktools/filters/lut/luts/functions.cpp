...
template<class T>
static void custom_c(Byte *pDst, int nDstPitch, const Byte *pSrc, int nSrcPitch, const Byte *pLut, const int *pCoordinates, int nCoordinates, int nWidth, int nHeight)
{
