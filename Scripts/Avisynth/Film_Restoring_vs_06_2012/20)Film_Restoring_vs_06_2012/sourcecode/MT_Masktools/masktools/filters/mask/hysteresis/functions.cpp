...
static void expandMask(Byte *pDst, int nDstPitch, const Byte *pSrc1, int nSrc1Pitch,
                       const Byte *pSrc2, int nSrc2Pitch, Byte *pTemp, int x, int y, int nWidth, int nHeight)
{
...
void Filtering::MaskTools::Filters::Mask::Hysteresis::hysteresis_c(Byte *pDst, int nDstPitch, const Byte *pSrc1, int nSrc1Pitch,
                                                                   const Byte *pSrc2, int nSrc2Pitch, Byte *pTemp, int nWidth, int nHeight)
{
