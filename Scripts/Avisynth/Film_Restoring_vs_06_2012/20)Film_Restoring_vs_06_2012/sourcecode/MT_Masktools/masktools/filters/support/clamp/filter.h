...
typedef void(Processor)(Byte *pDst, int nDstPitch, const Byte *pSrc1, int nSrc1Pitch, const Byte *pSrc2, int nSrc2Pitch, int nWidth, int nHeight, int nOvershoot, int nUndershoot);
