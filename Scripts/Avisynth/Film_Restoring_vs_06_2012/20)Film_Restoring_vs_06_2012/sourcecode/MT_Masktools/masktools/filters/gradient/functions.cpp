...
typedef int (Distorsion)(const Byte *pSrc, int nSrcPitch, const Byte *pRef, int nRefPitch, int nPrecision);

template<int nBlockSizeX, int nBlockSizeY> int sad(const Byte *pSrc, int nSrcPitch, const Byte *pRef, int nRefPitch, int nPrecision)
{
   int nSad = 0;
...
template<Distorsion distorsion, int nBlockSizeX, int nBlockSizeY> void generic_c(Byte *pDst, int nDstPitch, const Byte *pSrc, int nSrcPitch, const Byte *pRef, int nRefPitch, int nWidth, int nHeight, int nX, int nY, int nMinimum, int nMaximum, int nPrecision)
{
   int x, y;
