...
public:
   ...
   Constraint();
   Constraint(CpuFlags flags, Modulo moduloX, Modulo moduloY, Alignment alignment);
   Constraint(CpuFlags flags, int nWidth, int nHeight, const Byte *pAddress, int nPitch);
   Constraint(CpuFlags flags, int nWidth, int nHeight, Int64 nAddress, int nPitch);
