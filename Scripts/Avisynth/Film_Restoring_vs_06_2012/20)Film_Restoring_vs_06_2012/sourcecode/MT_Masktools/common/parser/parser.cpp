...
Parser::Parser &Parser::Parser::parse(const String &parsed_string, const String &separators)
{
   ...
   int nPos = parsed_string.find_first_not_of(separators, 0);
   int nEndPos = -1;
...
Parser::Parser Parser::getDefaultParser()
{
   ...
   /* function */
   parser.addSymbol(Symbol::Abs).addSymbol(Symbol::Acos).addSymbol(Symbol::Asin).addSymbol(Symbol::Atan).addSymbol(Symbol::Cos).addSymbol(Symbol::Exp).addSymbol(Symbol::Log).addSymbol(Symbol::Sin).addSymbol(Symbol::Tan).addSymbol(Symbol::Round).addSymbol(Symbol::Min).addSymbol(Symbol::Max).addSymbol(Symbol::Clip);
   /* number */
