...
public:
   ...
   Plane(T *pPixel, int nPitch, int nWidth, int nHeight) : pPixel(pPixel), nPitch(nPitch), nWidth(nWidth), nHeight(nHeight) { }
...
public:
   ...
   int pitch() const { return plane.pitch(); }
